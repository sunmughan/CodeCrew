...
@section('breadcrumb-title','Carousel Ayarları')
...
<li class="breadcrumb-item active">Carousel Ayarları
</li>
          ...
          <div class="row">
            <div class="col-12">
              <div class="mb-1 row">
                ...
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="ca_topText"  value="{{ $carousel->ca_topText }}" placeholder="Üst Yazı">
                </div>
              </div>
            </div>
            <div class="col-12">
              <div class="mb-1 row">
                ...
                <div class="col-sm-9">
                  <input type="email"  class="form-control" name="ca_mainText" value="{{ $carousel->ca_mainText }}" placeholder="Başlık">
                </div>
              </div>
            </div>
            <div class="col-12">
              <div class="mb-1 row">
                ...
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="ca_description" value="{{ $carousel->ca_description }}" placeholder="Açıklama">
                </div>
              </div>
            </div>
